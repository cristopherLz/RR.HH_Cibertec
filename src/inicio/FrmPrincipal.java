...
public class FrmPrincipal extends JFrame implements WindowListener, ActionListener {
	...
	public FrmPrincipal(String cad, int x, int y) {
		...
		desktop.setBackground(new Color(51, 153, 153));
		...
		mnAdministracin.setIcon(new ImageIcon("C:\\Users\\abiga\\git\\lp1_2021_1_grupo_05_jueves-aldave\\src\\imagenes\\anadir (1).png"));
		mnAdministracin.setVisible(false);
		menuBar.add(mnAdministracin);

		JMenu mnCrud = new JMenu("Crud (PC02)");
		mnCrud.setIcon(new ImageIcon("C:\\Users\\abiga\\git\\lp1_2021_1_grupo_05_jueves-aldave\\src\\imagenes\\sistema.png"));
		mnCrud.setVisible(false);
		menuBar.add(mnCrud);

		JMenu mnConsulta = new JMenu("Consulta (PC03)");
		mnConsulta.setIcon(new ImageIcon("C:\\Users\\abiga\\git\\lp1_2021_1_grupo_05_jueves-aldave\\src\\imagenes\\buscar (2).png"));
		mnConsulta.setVisible(false);
		menuBar.add(mnConsulta);

		JMenu mnReporte = new JMenu("Reporte (PC03)");
		mnReporte.setIcon(new ImageIcon("C:\\Users\\abiga\\git\\lp1_2021_1_grupo_05_jueves-aldave\\src\\imagenes\\folder-directory-reload-refresh_108581.png"));
		...
		mnConsulta.add(mntConsultaUsuario);
		...
		mnConsulta.add(mntConsultaProveedor);
